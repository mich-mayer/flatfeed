...
|---|---:|---:|---:|
| Error recall | 94.44% | 81.86%–98.46% | 34/36 |
| Missed-error rate | 5.56% | 1.54%–18.14% | 2/36 |
| False-alert rate | 0.00% | 0.00%–24.25% | 0/12 |
| Challenge-set precision | 100.00% | 89.85%–100.00% | 34/34 |
| Field-localization accuracy | 100.00% | 89.85%–100.00% | 34/34 |
...
| rooms | 14 | 12 | 12 | 85.71% | 60.06%–95.99% |
...
- Retries: 0
- Token usage: 66163 input, 56729 cached input, 2205 output, 1059 reasoning (n=48/48, complete)
- Total recorded cost: $0.070842 (n=48/48, complete)
- Cost per completed case: $0.001476
- Latency `synchronous_case`: p50 1140.19 ms, p95 1650.31 ms (n=48/48, complete)
