...
|---|---:|---:|---:|
| Error recall | 100.00% | 89.28%–100.00% | 32/32 |
| Missed-error rate | 0.00% | 0.00%–10.72% | 0/32 |
| False-alert rate | 0.00% | 0.00%–19.36% | 0/16 |
| Challenge-set precision | 100.00% | 89.28%–100.00% | 32/32 |
| Field-localization accuracy | 100.00% | 89.28%–100.00% | 32/32 |
...
- Retries: 0
- Token usage: 66090 input, 0 cached input, 2573 output, 1393 reasoning (n=48/48, complete)
- Total recorded cost: $0.203820 (n=48/48, complete)
- Cost per completed case: $0.004246
- Latency `synchronous_case`: p50 1483.23 ms, p95 3171.90 ms (n=48/48, complete)
