...
- Review gates: the 10s/30s scan tests (§22) for any case-page change; for the bot, "can a new user save a filter, receive or request matching cards, and manage saved data?".
